    ...
    public partial class PinFormWallet : Form
    {
        ...
        private void ButtonSendPinCode_ClickAsync(object sender, EventArgs e)
        {
            if (textBoxPinCode.Text.Length >= 4)
            {
                ...
                {
                    if (!await Program.WalletXenophyte.ClassWalletObject.WalletConnect
                        .SendPacketWallet(
...
#else
                MessageBox.Show(Program.WalletXenophyte, ClassTranslation.GetLanguageTextFromOrder("PIN_CODE_SUBMIT_MENU_WARNING_TEXT"));
#endif
            }
        }
